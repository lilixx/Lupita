...
<body>
  ...
  <h1 style="text-align:center; font-size:1.4em; border-bottom: 2px solid #000; margin-bottom:0px; padding-bottom:0px;">Detalle de Planilla de la Empresa: {{$cartera->empresa->nombre}} </h1>
  </header>
  <input name="_method" type="hidden" value="PUT">
   {{ csrf_field() }}

  <h1 style="text-align:center; margin-top: 0px; padding-top: 0px; padding-bottom: 0.5em; ">Planilla: {{$cartera->created_at}} </h1>
  ...
  <table class="tg">
    ...
    @foreach($deuda as $de)
      ...
      <tr>
       ...
       <td class="tg-us36">{{$de['cuotacant']}}</td>
       <td class="tg-us36">{{$de['cuotapag']}}</td>
       <td class="tg-us36">{{$de['cuotapen']}}</td>
    ...
    <tr>
      ...
      <td class="tg-us36">$ {{ number_format($totalin, 2)}}</td>
